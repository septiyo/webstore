...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>WebStore Septiyo.com</title>
	...
	<body class="no-trans">
					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="logo smooth-scroll">
								<a href="#banner"><img id="logo" src="images/logo.png" alt="Webstore Septiyo.Com"></a>
							</div>

							<!-- name-and-slogan -->
							<div class="site-name-and-slogan smooth-scroll">
								<div class="site-name"><a href="#banner">Webstore Septiyo.Com</a></div>
								<div class="site-slogan">Specialist Company Profile Web Developer <a target="_blank" href="http://septiyo.com">Septiyo.Com</a></div>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 object-non-visible" data-animation-effect="fadeIn">
							<h2 class="text-center">Kami Spesial Untuk <span>Perusahaan dan Bisnis anda yang Begitu Spesial</span></h2>
							<p class="lead text-center">Bisnis Anda begitu Penting, kami mengerti akan hal itu, kami ingin perusahaan anda terlihat begitu mengesankan Bahkan saat Customer
								Anda baru mengunjungi Website Anda. </p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="section clearfix object-non-visible" data-animation-effect="fadeIn">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 id="about" class="title text-center">About <span>Webstore Septiyo.com</span></h1>
						<p class="lead text-center">Kami adalah Spesial Team yang Developer.</p>
						<div class="space"></div>
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<p>Mengapa anda harus memilih kami untuk Website Company Pofile Anda?.</p>
								<p style="text-align: justify">Company Profile adalah ujung tombak bagi perusahaan untuk mengenalkan bisnis anda ke calon buyer Anda. Tentu anda tidak mau calon buyer Anda pindah
								ke Pesaing hanya karena tampilan Website yang buruk dan meragukan Bukan? kami memahami akan hal itu. Kami memiliki beberapa kelebihan Antara Lain :</p>
								<ul class="list-unstyled">
									<li><i class="fa fa-caret-right pr-10 text-colored"></i> Kami Spesialis dalam pembuatab Website Company Profile</li>
									<li><i class="fa fa-caret-right pr-10 text-colored"></i> Design Website Menarik dan Dinamis.</li>
									<li><i class="fa fa-caret-right pr-10 text-colored"></i> Tampilan Responsive, baik di PC, Tablet, Maupun SmartPhone</li>
									<li><i class="fa fa-caret-right pr-10 text-colored"></i> Menggunakan Teknologi terbaru</li>
									<li><i class="fa fa-caret-right pr-10 text-colored"></i> Harga Bersaing</li>
								</ul>
							</div>
						</div>
						<div class="space"></div>
